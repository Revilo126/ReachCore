...
public class MultiTileEntityPolymerizationChamber extends TileEntityBase10MultiBlockMachineMH<MultiTileEntityPolymerizationChamber> {
	...
	public Definition<MultiTileEntityPolymerizationChamber> getStructure() {
		if (DEFINITION == null) {
			DEFINITION = Definition.<MultiTileEntityPolymerizationChamber>builder(STRUCTURE)
					...
					.addElement('H', new StructureElementPart<>(this, 18101, getMultiTileEntityRegistryID(), 0, MultiTileEntityMultiBlockPart.ONLY_ENERGY_IN))
					.build();
		} 
		return DEFINITION;
	}
