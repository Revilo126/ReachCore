...
public class MultiTileEntityLargeSolarPanelElectric
    ...
    protected long mEnergy = 0, mOutput = 256;
    protected TagData mEnergyTypeEmitted = TD.Energy.QU;

    // Flat panel
    private String[][] STRUCTURE = { { "S-S" }, { "SSS" }, { "SSS" } };
    ...
    @Override
    public Definition<MultiTileEntityLargeSolarPanelElectric> getStructure() {
        return Definition.<MultiTileEntityLargeSolarPanelElectric>builder(STRUCTURE)
            .addElement(
                'S',
