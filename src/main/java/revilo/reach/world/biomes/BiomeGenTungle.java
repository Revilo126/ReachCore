...
public class BiomeGenTungle extends BiomeGenBase {

    public BiomeGenTungle(int biomeId, boolean register) {
        ...
        this.fillerBlock = this.topBlock = Tungle;
        this.biomeName = "Tungle";
    }
