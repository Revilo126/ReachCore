...
public class LoaderRecipesPlastics implements Runnable {
    ...
    public void run() {
        ...
        RM.BurnMixer.addRecipe1(
            ...
            128,
            ST.tag(0),
            FL.array(FL.Ethylene.make(30), MT.Cl.gas(10, F)),
            RCMT.EDC.liquid(56, F),
            NI);
        RM.CatalyticCracking
            .addRecipe1(T, 16, 512, ST.tag(0), RCMT.EDC.liquid(56, F), RCMT.VCM.gas(36, F), MT.HCl.gas(20, F));
    }
