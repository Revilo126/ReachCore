...
public class BiomeLoader implements Runnable {
    ...
    public void run() {
        ...
        alkalai = new BiomeGenAlkalai(ConfigsRC.BIOME.get(ConfigCatagories.biomeIds, "alkalaiId", 241), T)
            .setBiomeName("Alkalai");
        sulf = new BiomeGenSulf(ConfigsRC.BIOME.get(ConfigCatagories.biomeIds, "sulfId", 242), T).setBiomeName("Sulf");
        tungle = new BiomeGenTungle(ConfigsRC.BIOME.get(ConfigCatagories.biomeIds, "tungleId", 243), T)
            .setBiomeName("Tungle");
